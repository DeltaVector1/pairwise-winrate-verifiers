...
class POLARRFTEnv(SingleTurnEnv):
    ...
    The environment expects a QA-style dataset with `question` and `answer` fields.
    It uses a ThinkParser to encourage <think>...</think> formatting and strips
    the thinking section when computing rewards.
    """
